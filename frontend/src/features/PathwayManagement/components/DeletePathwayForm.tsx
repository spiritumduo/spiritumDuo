...
>();
  ...
  const {
    ...
    setValue,
    control,
  } = useForm<DeletePathwayFormType>({ resolver: yupResolver(deletePathwaySchema) });
  ...
  const onSubmit = (
    mutation: typeof deletePathwayFunc, values: DeletePathwayFormType,
  ) => {
    mutation({
      variables: {
...
export default DeletePathwayForm;
