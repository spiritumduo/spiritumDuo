...
const Input = ({
  ...
  const _error = typeof error === 'string'
    ? <span className="nhsuk-error-message" id={ `${id}--error` } role="alert"><span className="nhsuk-u-visually-hidden">Error:</span>{ error }</span>
    : '';
  return (
