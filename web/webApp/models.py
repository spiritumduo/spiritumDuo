...
class patient(models.Model):
    ...
    hospitalNumber = models.CharField(_('Hospital number'), max_length=80, unique=True, null=True)
    nationalPatientNumber = models.CharField(_('NHS number'), max_length=80, unique=True, null=True)
