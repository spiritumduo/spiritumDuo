...
class OnPathway(db.Model):
    ...
    patient = db.Column('patient_id', db.Integer(), db.ForeignKey('tbl_patient.id'), nullable=False)
    pathway = db.Column('pathway_id', db.Integer(), db.ForeignKey('tbl_pathway.id'), nullable=False)
