...
async def resolve_patient_pathways(obj=None, info=None, pathwayId=None, isDischarged=False, awaitingDecisionType=None, limit=None, *_):
    return await OnPathwaysByPatient.load_from_id(context=info.context, id=obj.id, pathwayId=pathwayId, isDischarged=isDischarged, awaitingDecisionType=awaitingDecisionType, limit=limit)
