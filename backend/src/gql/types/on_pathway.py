...
async def resolve_on_pathway_pathway(obj=None, info:GraphQLResolveInfo=None, *_):
    return await PathwayByIdLoader.load_from_id(context=info.context, id=obj.pathway_id)

@OnPathwayObjectType.field("patient")
async def resolve_on_pathway_patient(obj=None, info:GraphQLResolveInfo=None, *_):
...
async def resolve_decision_points(obj=None, info:GraphQLResolveInfo=None, *_):
...
async def resolve_under_care_of(obj=None, info:GraphQLResolveInfo=None, *_):
...
async def resolver(obj=None, info:GraphQLResolveInfo=None, notOnDecisionPoint:bool=True, *_):
