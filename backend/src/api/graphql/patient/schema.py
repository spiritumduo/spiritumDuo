...
class PatientQueries(_PatientQueries, graphene.ObjectType):
    ...
    patient_search = graphene.Field(PatientType, 
        id=graphene.Int(),
    ...
    def resolve_patient_search(root, info, id=None, hospital_number=None, national_number=None, first_name=None, last_name=None, date_of_birth=None):
        return _PatientQueries._resolve_patient_search(root, info, id=id, hospital_number=hospital_number, national_number=national_number, first_name=first_name, last_name=last_name, date_of_birth=date_of_birth)
