...
class _PatientQueries(graphene.ObjectType):
    ...
    def _resolve_patient_search(root, info, id=None, hospital_number=None, national_number=None, first_name=None, last_name=None, date_of_birth=None): # Gets specified data only
