...
class DecisionPointQueries(_DecisionPointQueries, graphene.ObjectType):
    ...
    get_decision_point_by_record_id=graphene.Field(DecisionPointType, id=graphene.Int())
    get_decision_point_by_patient_id=graphene.List(DecisionPointType, id=graphene.Int())
